...
class Particle{
    public:
        ...
        Particle(float x, float y) : position(x,y), previous_position(x,y), acceleration(0,0), force_applied(false) {}
        ...
        void constrain_to_bounds(float width, float height, float radius) {   
            ...
            const float floor_damping = 0.3f;  // Reduces bounce height significantly
            ...
            const float min_bounce_velocity = 0.5f;
